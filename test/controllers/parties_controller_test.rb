...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { belongs_to: @party.belongs_to, details: @party.details, end_time: @party.end_time, location: @party.location, start_time: @party.start_time } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { belongs_to: @party.belongs_to, details: @party.details, end_time: @party.end_time, location: @party.location, start_time: @party.start_time } }
